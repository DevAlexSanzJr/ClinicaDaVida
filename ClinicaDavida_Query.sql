...
@codigo VARCHAR(50)
AS
INSERT Pacientes VALUES (@nombre, @edad, @estatura, @peso, @genero, @codigo);
--- EDITAR ---
...
@id INT
AS
UPDATE Pacientes SET nombre=@nombre, edad=@edad, estatura=@estatura, peso=@peso, genero=@genero, codigo=@codigo WHERE id=@id;
--- ELIMINAR ---
...
@id INT
AS
UPDATE Diagnostico SET nombrePaciente=@nombrePaciente, nombreMedico=@nombreMedico, descripcion=@descripcion, diagnostico=@diagnostico, medicamento_Uno=@medicamentoUno, medicamento_Dos=@medicamentoDos, medicamento_Tres=@medicamentoTres, medicamento_Cuatro=@medicamentoCuatro WHERE id=@id;
--- ELIMINAR ---
