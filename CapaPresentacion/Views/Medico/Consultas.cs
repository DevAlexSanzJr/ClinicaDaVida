...
namespace CapaPresentacion.Views.Medico
{
    public partial class Consultas : Form
    {
        ...
        private void GuardarConsultaMedico()
        {
            try
            {
                if (txtPaciente.Text != "" && txtMedico.Text != "" && txtDesc.Text != "" && txtDiagnostico.Text != "" && cbMedicamentoUno.Text != "")
                {
                    if (Editar == false)
                    {
                        try
        ...
        private void cbMedicamentoUno_KeyPress(object sender, KeyPressEventArgs e)
        {
        ...
        private void cbMedicamentoDos_KeyPress(object sender, KeyPressEventArgs e)
        {
            if (!(char.IsLetter(e.KeyChar)) && (e.KeyChar != (char)Keys.Back))
            {
                MessageBox.Show("Solo se permiten letras y espacios", "Advertencia", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
        ...
        private void cbMedicamentoTres_KeyPress(object sender, KeyPressEventArgs e)
        {
            if (!(char.IsLetter(e.KeyChar)) && (e.KeyChar != (char)Keys.Back))
            {
                MessageBox.Show("Solo se permiten letras y espacios", "Advertencia", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
        ...
        private void cbMedicamentoCuatro_KeyPress(object sender, KeyPressEventArgs e)
        {
            if (!(char.IsLetter(e.KeyChar)) && (e.KeyChar != (char)Keys.Back))
            {
                MessageBox.Show("Solo se permiten letras y espacios", "Advertencia", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
