...
namespace CapaPresentacion
{
    public partial class InicioSesion : Form
    {
        ...
        private void cbInicioSesión_KeyPress(object sender, KeyPressEventArgs e)
        {
        ...
        private void txtPass_KeyPress(object sender, KeyPressEventArgs e)
        {
            if (!(char.IsLetter(e.KeyChar)) && (e.KeyChar != (char)Keys.Back) && (e.KeyChar == char.Parse(" ")))
            {
                MessageBox.Show("Solo se permiten letras, nmeros y carácteres especiales", "Advertencia", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                e.Handled = true;
            }
        }
    }
