            ...
            try
            {
                if (txtNombre.Text != "" && txtEdad.Text != "" && cbGenero.Text != "" && txtCodigo.Text != "")
                {
                    if (Editar == false)
                    {
                        try
                        {
                            objetoCN.CrearPaciente(txtNombre.Text, Convert.ToInt32(txtEdad.Text), cbGenero.Text, txtCodigo.Text);
                    ...
                    if (Editar == true)
                    {
                        try
                        {
                            objetoCN.EditarPaciente(txtNombre.Text, txtEdad.Text, cbGenero.Text, txtCodigo.Text, idPaciente);
