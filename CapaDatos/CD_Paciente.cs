...
namespace CapaDatos
{
    public class CD_Paciente
    {
        ...
        public void Crear(string nombre, int edad, double estatura, double peso,string genero, string codigo)
        {
            comando.Connection = conexion.AbrirConexion();
        ...
        public void Editar(string nombre, int edad, double estatura, double peso, string genero, string codigo, int id)
        {
            comando.Connection = conexion.AbrirConexion();
